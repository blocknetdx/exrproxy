...
#        logging.warning(json_data)
    ...
    if 'method' in json_data and json_data['method'] == 'get_project_stats':
        status = "cancelled" if g.project.user_cancelled \
            ...
            "result":
              {
                ...
                "payment_eth_address": g.payment.eth_address,
                "payment_avax_address": g.payment.avax_address,
                "payment_nevm_address": g.payment.nevm_address,
